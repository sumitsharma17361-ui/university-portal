      ...
      apiRes.on("end", () => {
        try {
          ...
          if (json.choices && json.choices[0]) {
            ...
            res.status(200).json({ reply: "SITM Module Response Error." });
          }
