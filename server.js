    ...
    <body>
      ...
      <script>
        ...
        async function publishResult() {
          ...
          try {
            ...
            if(out.success) {
              ...
              // Shows Mongoose validation error (e.g. if marks > 100)
        ...
        // PDF Generation Script
          ...
          // Fix: Ensure element is visible before rendering
          ...
          // Added a small timeout to let the browser paint the element
          setTimeout(() => {
